...
export default function Appointments() {
  ...
  const fetchEntries = useCallback(() => {
    ...
    getAppointments()
      ...
      .catch(() => {
        setLoadError("Couldn't load the appointments. Please try again.");
      })
      .finally(() => {
        setLoading(false);
      });
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5]">
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        <p className="text-[#F4882A] font-heading text-sm font-semibold uppercase tracking-wide">Appointments Information</p>
        ...
        {loadError ? (
          ...
          <p className="text-sm text-gray-500">No appointments have been added yet.</p>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {entries.map((entry) => (
              <div
