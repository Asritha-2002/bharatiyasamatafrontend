...
import { getHowToHelps } from '../api/howToHelp.js';
...
export default function HowToHelp() {
  ...
  const fetchEntries = useCallback(() => {
    ...
    getHowToHelps()
      ...
      .catch(() => {
        setLoadError("Couldn't load the how-to-help entries. Please try again.");
      })
      .finally(() => {
        setLoading(false);
      });
    ...
    <div className="min-h-screen bg-[#F5F5F5]">
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        {loadError ? (
          ...
          <p className="text-sm text-gray-500">No entries have been added yet.</p>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {entries.map((entry) => (
              <div
              ...
              >
                ...
                {(entry.pdfUrl || (entry.links && entry.links.length > 0)) && (
